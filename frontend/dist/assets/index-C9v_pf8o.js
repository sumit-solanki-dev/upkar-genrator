...
`,G=1081;function H({links:t=[]}={}){const e=document.createElement("header"),a=A(window.location.pathname),i=a.replace(/\/$/,"")||"/",n=["/","/products","/about","/contact"].includes(i);e.className=T("site-header js-site-header",n&&"site-header--dark-bg"),e.dataset.nav="header",e.dataset.animate="navbar",e.innerHTML=`
  ...
  `,{nodes:[t]}}async function J(){const[{createHeroSection:t},{createScrollSequenceSection:e},{createCompanyStatsSection:a},{createIndustriesWeServeSection:i},{createManufacturingProcessSection:n},{createTestimonialsSection:o},{createCTASection:l},{createFeaturedProductsSection:c}]=await Promise.all([r(()=>import("./Hero-Cg5W7gxj.js"),[]),r(()=>import("./ScrollSequence-dCbrZm6G.js"),[]),r(()=>import("./CompanyStats-CgKN3Z81.js"),[]),r(()=>import("./IndustriesWeServe-CRIISRQK.js"),[]),r(()=>import("./ManufacturingProcess-DoFbR6ep.js"),[]),r(()=>import("./Testimonials-orXivqBi.js"),[]),r(()=>import("./CTA-CTEUn1jX.js"),[]),r(()=>import("./FeaturedProducts-DDCxIb6n.js"),[])]);return O({title:"UPKAR Generator",description:"UPKAR Generator builds dependable diesel generator solutions for factories, hospitals, hotels, construction, agriculture, telecom, and commercial facilities.",path:"/"}),{nodes:[t(),e(),a(),i(),n(),o(),l(),await c()],enhance:Z}}async function Q(t){if(t==="/products"){const{createProductListingPage:e}=await r(async()=>{const{createProductListingPage:a}=await import("./ProductListingPage-GSKr9AMQ.js");return{createProductListingPage:a}},[]);return{nodes:[await e()]}}if(t.startsWith("/products/")){const e=t.replace("/products/",""),{createProductDetailsPage:a}=await r(async()=>{const{createProductDetailsPage:i}=await import("./ProductDetailsPage-BVMGpLa7.js");return{createProductDetailsPage:i}},[]);return{nodes:[await a(e)]}}if(t==="/contact"){const{createContactPage:e}=await r(async()=>{const{createContactPage:a}=await import("./ContactPage-7Em8eHy4.js");return{createContactPage:a}},[]);return{nodes:[e()]}}if(t==="/about"){const{createAboutPage:e}=await r(async()=>{const{createAboutPage:a}=await import("./AboutPage-BHM6GUSC.js");return{createAboutPage:a}},[]);return{nodes:[await e()]}}if(t==="/services"){const{createServicesPage:e}=await r(async()=>{const{createServicesPage:a}=await import("./ServicesPage-Dy8YyvL1.js");return{createServicesPage:a}},[]);return{nodes:[await e()]}}return J()}function Z(){C(async()=>{const[{initLenis:t},{initHeroAnimations:e},{initScrollSequence:a},{initCompanyStatsAnimations:i},{initIndustriesAnimations:n},{initManufacturingProcessAnimations:o},{initSwipers:l}]=await Promise.all([r(()=>import("./lenis-CgqyWAU5.js"),__vite__mapDeps([2,1,3])),r(()=>import("./gsap-Ctd5YKNO.js"),__vite__mapDeps([0,1])),r(()=>import("./scrollSequence-CgGGTTGV.js"),__vite__mapDeps([4,1])),r(()=>import("./companyStats-Cd1cj_Xm.js"),__vite__mapDeps([5,1])),r(()=>import("./industries-DHGs1wbF.js"),__vite__mapDeps([6,1])),r(()=>import("./manufacturingProcess-85SIWgy3.js"),__vite__mapDeps([7,1])),r(()=>import("./swiper-DtDjfTGV.js"),__vite__mapDeps([8,9,10]))]);t(),e(),a(),i(),n(),o(),l("[data-featured-products-slider]"),l("[data-testimonials-slider]",{loop:!k(),autoplay:k()?!1:{delay:3200,disableOnInteraction:!1,pauseOnMouseEnter:!0},breakpoints:{700:{slidesPerView:2},1100:{slidesPerView:3}}})})}async function X(){P("#navigation-root")?.replaceChildren(H({links:D.primary})),z();const t=P("#app"),e=A(window.location.pathname);t?.setAttribute("aria-busy","true");let a;try{a=await Q(e)}catch{a=Y()}t?.replaceChildren(...a.nodes,j()),t?.setAttribute("aria-busy","false"),P("[data-site-footer]")?.remove(),t?.after(q()),a.enhance?.()}X();export{f as C,O as s};
