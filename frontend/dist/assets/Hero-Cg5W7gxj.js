const e="UPKAR Generator";function t(a){return a.split(" ").map(r=>`<span class="hero-title__word">${Array.from(r).map(s=>`<span class="hero-title__char">${s}</span>`).join("")}</span>`).join("")}function i(){const a=document.createElement("section");return a.className="hero-section",a.dataset.animate="hero",a.innerHTML=`
    ...
    <div class="container hero-section__inner">
      <div class="hero-copy">
        ...
        <h1 class="hero-title" aria-label="${e}">
  ...
  `,a}export{i as createHeroSection};
