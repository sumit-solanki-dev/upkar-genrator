import{s as E}from"./index-BatIcB3M.js";async function q(){try{return await(await fetch(`/products.json?v=${new Date().getTime()}`,{cache:"no-store",headers:{"Cache-Control":"no-cache"}})).json()}catch(a){return console.error("Failed to load products:",a),[]}}function C(a){return`
