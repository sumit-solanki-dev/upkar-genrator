const t={frameCount:216,frameStart:1,framePad:4,framePath:"/images/sequence/frame_{frame}.jpg",frameFit:"contain"};function r(s={}){const a={...t,...s},e=document.createElement("section");return e.className="scroll-sequence",e.dataset.scrollSequence="generator",e.dataset.frameCount=String(a.frameCount),e.dataset.frameStart=String(a.frameStart),e.dataset.framePad=String(a.framePad),e.dataset.framePath=a.framePath,e.dataset.frameFit=a.frameFit,e.innerHTML=`
  ...
  `,e}export{t as SCROLL_SEQUENCE_CONFIG,r as createScrollSequenceSection};
