...
function getWhatsAppLink(phone) {
  ...
  const message = encodeURIComponent("Hello UPKAR Generator, I would like to request a quote.");
...
export function createContactPage() {
  setPageMeta({
    title: "Contact",
    description:
      "Contact UPKAR Generator for diesel generator quotes, service support, business hours, phone, email, and location details.",
    path: "/contact/",
  });

  const page = document.createElement("div");
  const whatsappLink = getWhatsAppLink(COMPANY.phone);
        ...
        <aside class="contact-details" aria-label="Company details">
          <div class="contact-details__card">
            ...
            <div class="contact-details__actions">
              <a class="contact-details__button contact-details__button--call" href="tel:${COMPANY.phone}">Call Now</a>
              <a class="contact-details__button contact-details__button--whatsapp" href="${whatsappLink}" target="_blank" rel="noopener noreferrer">WhatsApp</a>
              <a class="contact-details__button contact-details__button--email" href="mailto:${COMPANY.email}">Email</a>
            </div>
          </div>
